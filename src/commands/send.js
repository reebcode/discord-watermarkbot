            ...
            if (message.attachments.first()) {
                ...
                if (message.attachments.first().width > 3000) {
                    canvas = Canvas.createCanvas(
                        message.attachments.first().width / 1.5,
                        message.attachments.first().height / 1.5
                    )
                } else {
                ...
                if (message.mentions.users.first()) {
                    ...
                    if (
                        message.guild.channels.cache.find((channel) => channel.name === user + '-private') != undefined
                    ) {
                        ctx.fillText(
                        ...
                        message.guild.channels.cache
                            .find((channel) => channel.name === user + '-private')
                            .send(attachment)
                        message.delete()
                    ...
                    message.guild.members.cache.forEach((member) => {
                        ...
                        if (
                            (member.roles.cache.has(message.mentions.roles.first().id) ||
                                higherRole(message.mentions.roles.first().id, member) == true) &&
                            !member.user.bot
                        ) {
                            ...
                            if (
                                message.guild.channels.cache.find((channel) => channel.name === user + '-private') !=
                                undefined
                            ) {
                                ctx.drawImage(background, 0, 0, canvas.width, canvas.height)
                                ctx.fillText(
        ...
        //No watermark CMDS
            ...
            if (args[1] === 'help') {
                return message.reply(
                    'Use this command to send a message to a users private channel. "-send (@role/@user) (yes/no message) (yes/no watermark)" If sending an attachment message is optional, watermark will add a watermark if left in.'
                )
            }
            //Send MSG command -send @role/@mention yes
                ...
                message
                    .reply(`Please send the message you would like to be sent out`)
                            ...
                            if (
                                ...
                                if (
                                    message.guild.channels.cache.find(
                                        (channel) => channel.name === user + '-private'
                                    ) != undefined
                                ) {
                                    message.guild.channels.cache
                                        .find((channel) => channel.name === user + '-private')
